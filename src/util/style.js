export const styles ={
   ...
   flexBetween:'flex justify-between items-center',
    paragraph: 'font-montserrat font-normal text-lightWhite text-[18px] leading-[1.8]',
    heading1: 'font-montserrat font-semibold ss:text-[72px] text-[52px] text-white ss:leading-[100px] leading-[75px]',
    heading2: 'font-montserrat font-semibold xs:text-[48px] text-[40px] text-white xs:leading-[76.8px]',
